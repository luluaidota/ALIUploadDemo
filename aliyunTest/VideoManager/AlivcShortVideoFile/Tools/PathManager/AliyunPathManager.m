...
+ (NSString *)aliyunRootPath {
    return [[self rootPath] stringByAppendingPathComponent:@"com.ringle.haoji"];
}

+ (NSString *)quCachePath {
    return [[self cachePath] stringByAppendingPathComponent:@"com.ringle.haoji"];
}
...
+ (NSString *)quRelativeRootPath {
    ...
    return @"Documents/com.ringle.haoji";
}
